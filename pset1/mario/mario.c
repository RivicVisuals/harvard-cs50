...
int main(void)
{
    ...
    for (int line = 0; line < height; line++)
    {
        ...
        {
            //before we print hashes, we need to print (height - current line) spaces
            if (width < height - line)
            {
                printf(" ");
            }
            //this is the last hash of the left half, print with spacers
            else if (width == height)
            {
                printf("#  ");
            }
            //draw the right half up to the correct width
            else if (width > height + line + 1)
            {
                break;
            }
            else
